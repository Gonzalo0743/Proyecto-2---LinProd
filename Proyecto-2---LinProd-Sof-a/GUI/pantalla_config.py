...
class PantallaConfig:
    ...
    def draw(self, surf):
        ...
        surf.blit(self.f_small.render("PARAMETROS DE SIMULACION", True, GRIS_CLR), (40, 510))
        # Etiquetas ENCIMA de los campos (con separacion clara)
        surf.blit(self.f_small.render("Productos", True, GRIS_CLR), (40, 520))
        surf.blit(self.f_small.render("Velocidad", True, GRIS_CLR), (180, 520))
